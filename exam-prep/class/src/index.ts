...
function main() {
    ...
    //TODO Product: dress with size 36, color red 
    ...
    //TODO Product: jeans with size 32, color blue 

    // Get Cloth 

    const getCloth = magazine.getCloth("brown");

    //TODO Product: t-shirt with size 34, color brown 

    console.log(getCloth?.toString());
    console.log(magazine.report());

    //TODO Zara magazine contains: 
    //TODO Product: jeans with size 32, color blue 
    //TODO Product: t-shirt with size 34, color brown 
    //TODO Product: dress with size 36, color red 
}
