...
let Employee = (() => {
    ...
    return _a = class Employee {
            constructor() {
                this.tasks = __runInitializers(this, _tasks_initializers, []);
                this.extraTasks = (__runInitializers(this, _tasks_extraInitializers), __runInitializers(this, _extraTasks_initializers, []));
                __runInitializers(this, _extraTasks_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _tasks_decorators = [withTask({ name: "Basic task", level: "low" })];
